...
type
  ...
  TSQLite3RegularFunction = procedure(Context: PSQLite3Context; ArgCount: Integer; Args: PPSQLite3ValueArray); cdecl;
 ...
 *
 *    procedure MyFunction(Context: Pointer; n: integer; Args: PPSQLite3ValueArray); cdecl;
 *    begin
 ...
 *
 *  **You can't define an application-defined function anonmously.  It has to be cdecl.
 **************************************************************************************************)
begin
